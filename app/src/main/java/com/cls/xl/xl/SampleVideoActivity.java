...
public class SampleVideoActivity extends Activity {
...
//        videoUrls.put("hls", "http://192.168.1.207/hls0/x.m3u8");
    ...
    class VideoAdapter extends RecyclerView.Adapter<SampleVideoActivity.VideoHolder> {

        @Override
        public SampleVideoActivity.VideoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new SampleVideoActivity.VideoHolder(LayoutInflater.from(SampleVideoActivity.this).inflate(R.layout.item_video, parent, false));
        }

        @Override
        public void onBindViewHolder(final SampleVideoActivity.VideoHolder holder, int position) {
            final String name = nameList.get(position);
            holder.videoName.setText(name);
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SampleVideoActivity.this, SinglePlayerActivity.class);
